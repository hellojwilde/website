    ...
    <div>
      ...
      <div className="mt-12 mx-auto px-4 container">
        <aside className="p-8 border-t-2 text-center">
          ...
          <p className="mt-4">
            <Link
              className="rounded-lg border-2 border-slate-300 py-2.5 px-4 bg-slate-300 text-slate-800 hover:border-slate-500 hover:text-white hover:bg-slate-500 active:bg-slate-600 active:border-slate-600 transition-colors"
              to="/archive/"
            >
              View the Archives
            </Link>
